...
\item 
   ...
   \begin{enumerate}
      \item Analyser asymptotiquement (notation $O$ ou $\Theta$):
         \begin{enumerate}
            \item le nombre d'opérations effectuées (travail) = 
      ...
      \item Analyser précisément en donnant un équivalent (donc  pas en notation $O$ ou $\Theta$):
         \begin{enumerate}
          \item l'espace mémoire requis par votre programme= 
           \item le nombre de défauts de localité (cache) =  \\
